// Java Processing code by jn3008 (Joseff N)
//
// Copyright (c) 2023 jn3008
//
// All rights reserved.
//
// This code and the related animations are the property of the copyright holder.
// Any reproduction, distribution, or use of this material, in whole or in part, 
// without the express written permission of the copyright holder is strictly 
// prohibited. You cannot sell this work and you cannot mint any NFTs of it or 
// train a neural network with it without permission.
// ----------------------------------------------------------------------------
//
// come back
//
